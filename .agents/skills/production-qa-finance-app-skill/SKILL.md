---
name: production_qa_finance_app
description: QA production cho app finance/import/AI trước khi redeploy.
version: 1.0.0
owner: Com Tam Lang Finance App
---

# Production QA Finance App Skill

## Purpose
Chuẩn hóa checklist test/build/secret/audit cho từng release.

## When to Use
Trước khi xuất zip hoặc redeploy Vercel.
