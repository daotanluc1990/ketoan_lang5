...
description: Giải thích preview/confirm import, lỗi, trùng, lệch và khuyến nghị confirm.
version: 1.0.0
...
## Purpose
Chuẩn hóa cách AI giải thích kết quả import preview/confirm và cảnh báo dữ liệu lỗi.

## When to Use
Khi kế toán import file hoặc cần kiểm tra batch import.
