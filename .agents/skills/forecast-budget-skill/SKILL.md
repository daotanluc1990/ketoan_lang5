...
description: Quy tắc Agent Dự toán: code tính số, AI giải thích giả định/rủi ro.
version: 1.1.0
owner: Com Tam Lang Finance App
---

# Forecast Budget Skill

## Purpose
Chuẩn hóa dự toán tuần tới, yêu cầu tối thiểu lịch sử và quy trình CEO duyệt.

## When to Use
Khi tạo hoặc kiểm tra Agent Dự toán.
...
- 1.1.0: V5.0 kích hoạt runtime dự toán nháp qua `/api/reports/du-toan` và `/api/ai/forecast-analysis`.
