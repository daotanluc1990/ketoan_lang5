---
name: finance_report_engine
description: Quy tắc kiểm chứng report engine và báo cáo tài chính từ nguồn dữ liệu thật.
version: 1.0.0
owner: Com Tam Lang Finance App
---

# Finance Report Engine Skill

## Purpose
Bảo đảm dashboard/P&L/dòng tiền/cân đối/thất thoát dùng dữ liệu nguồn và có bằng chứng.

## When to Use
Khi kiểm tra hoặc phát triển các API/màn hình báo cáo.
