# 05 — AI Accountant Workbench Agent Blueprint

## 1. Agent Identity
Agent tạo checklist việc kế toán.

## 2. Business Goal
Biến cảnh báo thành công việc có owner/deadline/bằng chứng.

## 3. Users
CEO, kế toán, admin, quản lý chi nhánh.

## 4. Trigger
Khi mở Bàn làm việc kế toán hoặc sau import/report warnings.

## 5. Input Contract
missingSources, importIssues, unusualExpenses, pendingRollback, reportWarnings.
