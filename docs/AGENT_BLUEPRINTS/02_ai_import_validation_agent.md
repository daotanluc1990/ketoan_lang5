# 02 — AI Import Validation Agent Blueprint

## 1. Agent Identity
Agent kiểm tra import dữ liệu.

## 2. Business Goal
Giảm thời gian kế toán kiểm tra file import và batch lỗi/trùng/lệch.

## 3. Users
CEO, kế toán, admin, quản lý chi nhánh.

## 4. Trigger
Sau /api/import/preview hoặc /api/import/confirm.

## 5. Input Contract
Import preview/confirm summary, dòng lỗi, dòng trùng, dòng lệch, batchId, targetSheets.
