...
import { quyTrinhChecklist } from '@/lib/tai-lieu/noi-dung';
...
export default function TaiLieuQuyTrinhPage() {
  return (
    <div className='space-y-4'>
      <PageHeader title='Quy trình & Checklist' description='Module Tài liệu nội bộ — tra cứu khi cần.' status='Đang dùng' />
      <div className='grid gap-3 md:grid-cols-2'>
        {quyTrinhChecklist.map((doc) => (
          <Card key={doc.id}>
