...
export default async function BaoCaoNgayPage() {
  const report = await buildAccountingOverview();
  return (
    <div className="space-y-4">
      <PageHeader title="Báo cáo ngày" description="Tổng hợp từ V7 engines (runtime, không lưu tĩnh)." status={report.status} />
